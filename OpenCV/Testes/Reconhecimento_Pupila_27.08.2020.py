...
circles	= cv2.HoughCircles(img,cv2.HOUGH_GRADIENT, 1, 120,param1=100,param2=30,minRadius=40,maxRadius=65)
...
cv2.imshow("Threshold Dinâmico", np.hstack([ th1, th2, th3]))
